...
def login(email, stored_logins, password_to_check):
    ...
    # Check if the email exists in the stored logins dictionary
...
def main():
    ...
    # Test case for an email that is not in stored_logins
    print(login("unknown@email.com", stored_logins, "password"))  # False
